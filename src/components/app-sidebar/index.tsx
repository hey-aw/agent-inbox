...
export function AppSidebarTrigger({
  ...
  // On mobile, always show a floating button at the top right with better contrast
  return (
    <Button
      onClick={toggleSidebar}
      variant="default"
      size="icon"
      className={
        "fixed top-4 right-4 z-50 rounded-full shadow-lg bg-black text-white border border-white/80 hover:bg-gray-800 p-4 flex items-center justify-center"
      }
